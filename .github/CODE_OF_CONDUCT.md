...
Replace all {{PLACEHOLDER}} values:
  rsr-template-repo     - Your project name
  hyperpolymath            - GitHub/GitLab username or org
  rsr-template-repo             - Repository name
...
We as members, contributors, and leaders pledge to make participation in rsr-template-repo a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, colour, religion, or sexual identity and orientation.
...
- Open a [Discussion](https://github.com/hyperpolymath/rsr-template-repo/discussions) (for general questions)
