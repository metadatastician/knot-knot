...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/knot-knot/security/advisories/new)
...
- This repository (`metadatastician/knot-knot`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/knot-knot/security/advisories)
...
When using knot-knot, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/knot-knot/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/knot-knot/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/knot-knot/discussions) |
...
*Thank you for helping keep knot-knot and its users safe.* 🛡️
