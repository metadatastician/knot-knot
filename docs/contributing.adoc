...
= Contributing — KnotKnot
:revdate: 2026-MM-DD

== Audience

Developers working *on* `KnotKnot`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/KnotKnot.git
cd KnotKnot
...
* Bugs in `KnotKnot`: file at `metadatastician/KnotKnot/issues`.
