...
// Replace knot-knot, julia --project=. -e 'using Pkg; Pkg.instantiate()', julia --project=. -e 'using Pkg; Pkg.test()', Julia (1.9+) with actuals
= knot-knot — Quick Start for Developers
:toc:
:toclevels: 2
