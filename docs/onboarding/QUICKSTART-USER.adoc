...
// Replace knot-knot, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= knot-knot — Quick Start for Users
:toc:
:toclevels: 2
...
[source,bash]
----
just install --portable --prefix=./knot-knot-portable
----
...
* **Wiki**: https://github.com/metadatastician/knot-knot/wiki
