...
cleanup() {
    echo "Received shutdown signal — stopping knot-knot..."
...
# Examples:
#   exec /app/knot-knot
#   exec /app/release/bin/knot-knot start
#   exec /app/knot-knot serve --host "${APP_HOST}" --port "${APP_PORT}"
